...
export const IPC = {
  ...
  UpdateCheckNow: 'app:update-check',     // renderer -> main: check right now
  UpdateStatusGet: 'app:update-status',   // renderer -> main: current status
  UpdateStatusChanged: 'app:update-changed', // main -> renderer
